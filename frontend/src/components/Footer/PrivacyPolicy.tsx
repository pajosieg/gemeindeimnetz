...
export const PrivacyPolicy = () => (
  <div className="impressum">
    ...
    <p>
      ...
      <a
        href="https://www.gemeinde-im-netz.de"
        target="_blank"
        rel="noopener noreferrer"
      >
        https://www.gemeinde-im-netz.de
      </a>
    </p>
    ...
    <p>
      ...
      oder verbindlicher interner Datenschutzvorschriften, verarbeiten (Art. 44 bis
    ...
    <ul>
      ...
      <li>
        ...
        eine Website erneut besucht. Ebenso können die Interessen von Nutzern, die
        zur Reichweitenmessung oder zu Marketingzwecken verwendet werden, in einem
      ...
      <li>
        <strong>Statistik-, Marketing- und Personalisierungs-Cookies</strong>: Ferner
    ...
    <p>
      <strong>Hinweise zu Rechtsgrundlagen: </strong> Auf welcher Rechtsgrundlage wir
    ...
    <p>
      ...
      Zwecken des Onlinemarketings kann auch mittels einer Vielzahl von Diensten, vor
    ...
    <ul className="m-elements">
      ...
      <li>
        <strong>undefined:</strong> Content Delivery Network (CDN).
      </li>
      <li>
    ...
    <ul className="m-elements">
      <li>
        ...
        Dienstleistungen; Dienstanbieter: Amazon Web Services, Inc., 410 Terry Avenue
        North, Seattle WA 98109, USA; Website:{' '}
        <a
        ...
        ; Privacy Shield (Gewährleistung Datenschutzniveau bei Verarbeitung von Daten
        in den USA):{' '}
        <a
    ...
    <ul className="m-elements">
      ...
      <li>
        <strong>undefined:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
        f. DSGVO).
      </li>
    </ul>
    <p>
    ...
    <ul className="glossary">
      ...
      <li>
        <strong>Verantwortlicher:</strong> Als "Verantwortlicher“ wird die natürliche
    ...
    <ul className="m-elements">
      <li>
        <strong>Begrifflichkeiten:</strong> Personenbezogene Daten, Verantwortlicher,
        Verarbeitung.
      </li>
    </ul>
    <p className="seal">
